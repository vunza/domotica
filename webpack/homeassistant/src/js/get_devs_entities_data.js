 ...
 * @param {String} api Endpoint dos dispositivosentidades do HA
 * @returns {Promise<Array>} Uma promessa que resolve para um array de dispositivos Zigbee.
 */
async function getZigbeeDevices(api) {    
    
   try {
        // Buscar o token do arquivo JSON local
        const resposta = await fetch('/local/json_files/token_api.json');
