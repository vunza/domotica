...
function createCardElement(card) {
    ...
    const iconMap = {
        ...
        clock: '<svg class = "svg_clk" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>',
    ...
    cardElement.innerHTML =         
        ...
        <div class="card-content">
            <div id="${card.id}.div_img_clock" class="div_img_clock">${iconMap.clock}</div>
            <div id="${card.id}.content" class="div_content">${card.content}</div>            
        </div>`;
