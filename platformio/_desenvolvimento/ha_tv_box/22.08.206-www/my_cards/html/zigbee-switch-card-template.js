export const switchCardTemplate = (initialTitle, clockSvg, menuHtml) => `
  <div class="card">
    <div class="card-header" data-device-mac-address="">
      <div class="card-title">
        <span class="card-icon" id="toggle-icon">          
          <ha-icon id="card-icon" icon="mdi:toggle-switch-off-outline"></ha-icon> 
        </span>
    ...
    <!-- Painel de Telemetria / KPIs do Interruptor -->
