export const lightCardTemplate = (initialTitle, clockSvg, menuHtml) => `
  <div class="card">
    ...
    <!-- Painel de Telemetria (Potência, Tensão, Corrente) -->
    ...
    <!-- Controle de Brilho Específico de Iluminação -->
    <div class="brightness-container hidden" id="brightness-box">
      <ha-icon icon="mdi:brightness-5" class="brightness-icon"></ha-icon>
      <input type="range" class="brightness-slider" id="brightness-range" min="1" max="100" value="0">
      <span class="brightness-value" id="brightness-text">0%</span>
    </div>

    <!-- Gráfico SVG para Histórico -->
