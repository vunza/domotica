export const timerModalStyles = `
  ...
  /* Adicionar/atualizar na constante timerModalStyles */
  .btn-save, #btn-guardar {
  ...
  .btn-save:hover, #btn-guardar:hover {
    background-color: var(--primary-color-dark, #0288d1);
    box-shadow: 0 4px 12px rgba(3, 169, 244, 0.3);
  }

  /* Efeito ao clicar (pressionar) */
  .btn-save:active, #btn-guardar:active {
    transform: scale(0.95);
  }

  /* Estado desabilitado durante o salvamento */
  .btn-save:disabled, #btn-guardar:disabled {
    background-color: var(--disabled-text-color, #b0bec5);
    cursor: not-allowed;
    opacity: 0.65;
    transform: none;
    box-shadow: none;
