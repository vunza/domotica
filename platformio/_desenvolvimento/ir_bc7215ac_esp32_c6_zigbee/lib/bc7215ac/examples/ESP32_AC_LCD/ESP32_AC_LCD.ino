/*
 * ESP32 Air Conditioner Control Offline Edition
 *
...
void loop()
{
    ...
    case IR_SENDING:
        ...
        {
            if (millis() - startTime > 3000)        // Transmitting overtime
            {
                irSending = false;
...
void powerup()
{
    ...
    {
    case STEP1:
        // Clear screen and initialize BC7215A
        ...
        delay(50);
        bc7215Board.setShutDown();        // Put BC7215A in shutdown mode to check BC7215A presence
        startTime = millis();
